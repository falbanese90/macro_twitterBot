This script extracts Macro Events from tradingeconomics.com/calendar,
...
It will also require a profile with the twitter API and the neccesary access codes.
